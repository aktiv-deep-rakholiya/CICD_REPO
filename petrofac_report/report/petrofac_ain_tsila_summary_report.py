...
class PetrofacAinTsilaSummaryReport(models.TransientModel):
    _name = "petrofac.ain.tsila.summary.report"
    _description = "Petrofac Ain Tsila Timesheet Report"
    ...
    def generate_report_excel(self):
        ...
        return {
            ...
            'view_type': 'form',
            'res_id': self.id,
            'res_model': 'petrofac.ain.tsila.summary.report',
            'target': 'new',
