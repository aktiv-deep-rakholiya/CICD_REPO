...
class EdifNdeSummaryReport(models.TransientModel):
    _name = "edif.nde.summary.report"
    _description = "EDIF Nde Timesheet Report"
    ...
    def generate_report_excel(self):
        ...
        sheet1.write_merge(next3_row,next3_row, 0,1, 'Name of Aprroving Authority :'+val['approver'], style_header_left)
        ...
        sheet1.write_merge(row, row, 0, 4,'PO Number : '+ name, style_header_left1)
        ...
        return {
            ...
            'view_type': 'form',
            'res_id': self.id,
            'res_model': 'edif.nde.summary.report',
            'target': 'new',
