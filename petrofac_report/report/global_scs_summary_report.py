...
class GlobalScsReport(models.TransientModel):
    _name = 'global.scs.summary.report'
    _inherit = 'common.report'
    _description = 'Global Scs Timesheet Report'
    ...
    def generate_report_excel(self):
        ...
        domain, fromdate, todate = self._get_calendar_domain(
            ...
            extra_domain=[
                ('code', 'in', ['global', 'tecton', 'sisisrl', 'swissapproval'])
            ]
        )
        ...
        def global_value_builder(record):
        ...
        start_values_data = self._group_calendar_records(
            calendar_event, global_value_builder
        )
        ...
        for start, categorious in start_values_data_sort:
            ...
            for category, records in categorious.items():
                ...
                worksheet.merge_range(next_row, 2, next_row, 4, str(totol_fullday), style_header_left)
                ...
                worksheet.merge_range(next2_row, 0, next2_row, 1, 'Name of Inspector : ' + records[0].get('employee', ''),
                                   style_header_left)
        ...
        return {
            ...
            'res_model': 'global.scs.summary.report',
            'target': 'new',
