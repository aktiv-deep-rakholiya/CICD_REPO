...
class PetrofacTinhertSummaryReport(models.TransientModel):
    _name = "petrofac.tinhert.summary.report"
    _description = "Petrofac Tinhert Timesheet Report"
    ...
    def generate_report_excel(self):
        ...
        return {
            ...
            'view_type': 'form',
            'res_id': self.id,
            'res_model': 'petrofac.tinhert.summary.report',
            'target': 'new',
