...
class EnzoneSummaryReport(models.TransientModel):
    _name = 'enzone.summary.report'
    _inherit = 'common.report'
    _description = 'Enzone Timesheet Report'
    ...
    def generate_report_excel(self):
        ...
        def enzone_value_builder(record):
        ...
        start_values_data = self._group_calendar_records(
            calendar_event, enzone_value_builder
        )
        ...
        for start, categorious in start_values_data_sort:
            for category, records in categorious.items():
                ...
                row = 7
                worksheet.write(7, 0, 'Name of Inspector', style_header_left)
                worksheet.merge_range(7, 1, 7, 10, start.split('_')[-1], style_header_left)
                ...
                for val in records:
                    ...
                    worksheet.write(row, 4, category, style_center_align_wrap)
        ...
        return {
            ...
            'res_model': 'enzone.summary.report',
            'target': 'new',
